...
public class RegisterForm {
    ...
    public static Target SELECT_COUNTRY_NAME = Target.the("select country").locatedBy("//select[@id='country']");
    ...
    public static Target ALERT_ALL_REQUIRED_FIELDS = Target.the("Requiered fields Alert").locatedBy("//div[@role='alert']");
