...
public class RegistrationStepDefinitions {
    ...
    //Metodo con camel case
    public void wantsToSingUpTheApplication(Actor actor) {
        actor.attemptsTo(
                Open.browserOn(new RegisterPage())
        );
    }
    @When("{actor} send the required information to sing up")
    public void sendTheRequiredInformationToSingUp(Actor actor, DataTable userInfo) throws URISyntaxException {
