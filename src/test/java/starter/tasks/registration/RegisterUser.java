    ...
    public <T extends Actor> void performAs(T actor) {
        try {
            actor.attemptsTo(
                    ...
                    SelectFromOptions.byVisibleText(expectedCountry).from(RegisterForm.SELECT_COUNTRY_NAME),
                    ...
                    Upload.theClasspathResource("pictures/img.jpg").to(RegisterForm.INPUT_PICTURE),
